...
const sampleProducts = [
  { id: 'p-1', name: 'Smartphone', price: 699, categoryId: 'cat-1', stock: 12, image: '' },
  { id: 'p-2', name: 'T-Shirt', price: 19.99, categoryId: 'cat-2', stock: 120, image: '' },
  { id: 'p-3', name: 'Coffee Maker', price: 49.5, categoryId: 'cat-3', stock: 22, image: '' },
];
...
export function AppProvider({ children }) {
  const [categories, setCategories] = useState(() => readLS(LS_KEYS.categories, sampleCategories));
  const [products, setProducts] = useState(() => readLS(LS_KEYS.products, sampleProducts));
  const [orders, setOrders] = useState(() => readLS(LS_KEYS.orders, sampleOrders));
