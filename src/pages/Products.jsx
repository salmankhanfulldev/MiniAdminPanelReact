...
export default function Products() {
  const { products, categories, addProduct, updateProduct, deleteProduct } = useContext(AppContext);
  ...
  return (
    <div className="page">
      ...
      {showForm && (
        <ProductForm categories={categories} onCancel={handleCancel} onSubmit={handleSubmit} initial={editing} />
      )}
            ...
            {visible.map(p => (
              <tr key={p.id}>
                ...
                <td>
                  ...
                  <button className="btn small muted" onClick={() => handleDelete(p.id)}>Delete</button>
                </td>
              </tr>
            ))}
          </tbody>
